...
The top three pet names are Lucy (483), Charlie (439), and Luna (387).
...
The relationsip is positive. This means that if a name is popular for one species, it is also somewhat popular for the other species. 
